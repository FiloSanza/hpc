...
int main( int argc, char* argv[] )
{
    ...
    /* compute the size of each local domain; this should be set to
      ...
      const int local_ext_width = local_width + HALO * 2;
    ...
    const int LOCAL_RIGHT_GHOST = LOCAL_LEFT + local_ext_width;
    const int LOCAL_RIGHT = LOCAL_RIGHT_GHOST - 1;
    ...
    for (s=0; s<steps; s++) {
        ...
        */
        MPI_Sendrecv(
            &local_cur[LOCAL_RIGHT],            // Send buff
            1,                                  // Qta
            MPI_CHAR,                           // Type
            rank_next,                          // Dest
            0,                                  // Tag
            &local_cur[LOCAL_LEFT_GHOST],       // Recv buff
            1,                                  // Qta
            MPI_CHAR,                           // Type
            rank_prev,                          // Src
            0,                                  // Tag
